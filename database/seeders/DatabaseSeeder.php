...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $models = ['user','branch' ,'product','coupon' ,'service' ,'role' , 'client' , 'event', 'feedback','achivement', 'ourwork','blog' ,'permission' ,'post', 'service' , 'lang' , 'slider' , 'category' , 'about' , 'contact' , 'location' , 'maincontact' , 'social'];
